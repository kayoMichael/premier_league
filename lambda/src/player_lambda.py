...
class PlayerLambda(PlayerSeasonLeaders):
    ...
    def handle_request(self):
        if self.path == "/player_ranking":
            ...
            return generate_http_response(save_to_s3(f"{self.filename}.pdf", S3_NAME), 200)
