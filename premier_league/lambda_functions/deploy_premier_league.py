...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Deploy Premier League functions to AWS Lambda')
    parser.add_argument('--aws-profile', help='AWS profile to use for deployment')
    parser.add_argument('--region', help='AWS region to deploy to (e.g., us-east-1, eu-west-1)')
